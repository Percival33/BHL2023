...
def test_scanned_product(w):
    while True:
        w.send(json.dumps({
            "type": "scanned_item",
            "item_id": "643b284676cdab22716407dd",
            "product_id": "643b248176cdab22716407bd"
        }))
        w.recv()


if __name__ == "__main__":
    with connect("ws://localhost:8000/dashboard/1") as websocket1:
        with connect("ws://localhost:8000/dashboard/2") as websocket2:
